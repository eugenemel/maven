...
T StatisticsVector<T>::minimum() const
{
  ...
  if(this->size() == 0 ) { std::cerr << "StatisticsVector::minimum() called with empty vector"; return 0;}
...
{
  if(this->size() == 0 ) { std::cerr << "StatisticsVector::maxiumum() called with empty vector"; return 0;}
...
Real StatisticsVector<T>::mean() const
{
  ...
  if(this->size() == 0 ) { std::cerr << "StatisticsVector::mean() called with empty vector"; return 0;}
...
{
  if(this->size() == 0 ) { std::cerr << "StatisticsVector::median() called with empty vector"; return 0;}
  const unsigned int n   = this->size();
...
Real StatisticsVector<T>::variance(const Real mean) const
{
  ...
  if(this->size() == 0 ) { std::cerr << "StatisticsVector::variance() called with empty vector"; return 0;}
...
{
  const unsigned int n   = this->size();
  if(this->size() == 0 ) { std::cerr << "StatisticsVector::histogram() called with empty vector";;}
