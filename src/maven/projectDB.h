...
class ProjectDB {
	...
	public: 
            ...
            map<int, tuple<string, string, int, float>> topMatch = {};
            multimap<int, tuple<string, string, int, float>> allMatches = {};
...
typedef map<int, tuple<string, string, int, float>>::iterator matchIterator;
